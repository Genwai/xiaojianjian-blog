layui.use(["jquery", "form", "layedit", "flow", "util", "layedit"], function() {
    $(document).ready(function() {
        ...
        建立编辑器
        var index = layedit.build("layui-edit", {
            height: 200,
        });
        ...
        form.on('submit(form-commmit-message)', function(data) {
            ...
            var LeaveMessage = layedit.getContent(index);
            if (LeaveMessage) {
                var html = '<li>' +
        ...
        $("body").on("click", '.about-user-huifu', function() {
        ...
        $('body').on('click', '.about-user-time a', function() {
